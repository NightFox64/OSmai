...
enum ret_type_t{
    ...
    ERROR_CREATE_FILE_MAPPING,  //Failed to create file mapping
    ERROR_MAP_VIEW_OF_FILE,     //Failed to map view of file
    ERROR_OPEN_FILE_MAPPING,    //Failed to open file mapping
